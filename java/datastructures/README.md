...
- Location: [InsertShiftArray](lib/src/main/java/datastructures/array/binarysearch/BinarySearch.java)
- Test : [InsertShiftArrayTest()](lib/src/test/java/datastructures/array/BinarySearchTest.java)
